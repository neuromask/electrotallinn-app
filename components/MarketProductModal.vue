<template>
  <b-modal body-bg-variant="light" header-bg-variant="light" size="xl" body-class="bg-lightning" scrollable centered :cancel-title="$t('action.cancel')" :id="modalId" :title="title" @ok="handleOk" @show="handleModalShow">
