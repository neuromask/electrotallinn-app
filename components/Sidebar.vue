<template>
    ...
    <div class="navbar">
        <b-sidebar id="sidebar-variant" title="ET⚡ Map" bg-variant="dark" text-variant="light" shadow backdrop>
            <div class="px-3 py-0">
            <b-img class="my-4" src="~/assets/img/circle.svg" fluid center></b-img>
            <b-list-group class="my-4">
                <b-list-group-item variant="info" class="font-weight-bold" to="map">Map</b-list-group-item>
                ...
                <b-alert show variant="primary">
                    <div class="d-flex justify-content-left align-items-center">
                        ...
                        <div class="ml-3">
                            ...
                            <a to="profile"><b-icon icon="person-bounding-box"></b-icon> Profile</a>
                        </div>
                    </div>
                </b-alert>
            </div>
