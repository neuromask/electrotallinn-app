    ...
    <b-card-group deck>
      ...
      <b-card-body>
        <b-list-group class="text-left">
          <b-list-group-item  v-b-toggle="'user-collapse+'+user.username" variant="primary">{{ user.first_name }}<b-badge variant="primary" pill>14</b-badge></b-list-group-item>
          <b-collapse :id="'user-collapse+'+user.username">
        ...
        <b-button variant="warning" class="m-3 position-absolute text-info" style="top:0;" @click="$router.push(`users/${user.uin}`)"><b-icon icon="person-bounding-box" /> Profile</b-button>
      </b-card>
    </b-card-group>
  </div>
</template>
